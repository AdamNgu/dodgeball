(function() {
  ...
  Game.prototype.draw = function(canvasContext) {
    // canvasContext.clearRect(0, 0, Game.DIM_X, Game.DIM_Y);
    this.allObjects().forEach(function(object) {
      object.draw(canvasContext);
    });
    canvasContext.fillStyle = "white";
    canvasContext.font = 16 + "pt Arial";
    var currentScoreText = "Score: " + this.score;
    canvasContext.fillText(currentScoreText, 20, 50);
    var highScoreText = "High Score: " + this.highScore;
    canvasContext.fillText(highScoreText, 20, 80);
  };

  Game.prototype.moveObjects = function(canvasContext) {
    this.allObjects().forEach(function(object) {
      object.move();
    });
  };
